"""Data tab for displaying trading transaction data in a tree view."""
...
class DataTab(QWidget):
    """Tab widget for displaying trading data in a sortable tree view."""
    ...
    def update_display(self, df):
        ...
        Args:
            df: DataFrame containing trading data to display
        """
    ...
    def sort_treeview(self, column):
        """
        Handle column sorting with toggle between ascending and descending.
